...
public class AddRoutineActivity extends AppCompatActivity implements ConditionPopUp.ConditionPopUpListener, ActionPopUp.ActionPopUpListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addConditionBtn = (ImageButton) findViewById(R.id.addCondition);
        addActionBtn = (ImageButton) findViewById(R.id.addActionBtn);
        done_fab = (FloatingActionButton)findViewById(R.id.done_fab);
        done_fab.setVisibility(View.GONE);

        conditionTxt = (TextView) findViewById(R.id.conditionPlaceholder);
        conditionTxt.setText("");
        actionTxt = (TextView) findViewById(R.id.actionPlaceholder);
        actionTxt.setText("");
    ...
    @Override
    public void onFinishCondition(String condition, String value) {
        Log.d("Popup Reply", condition + ": " + value);
        newRoutine.addCondition(condition, value);
